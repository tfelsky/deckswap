-- Folded from docs/sql/escrow-transaction-foundation.sql into a migration so `supabase db push`
...
drop policy if exists "users create trade drafts" on public.trade_transactions;
