-- Folded from docs/sql/commander-directory.sql into a migration so `supabase db push`
...
drop policy if exists "commander directory is publicly readable" on public.commander_directory;
