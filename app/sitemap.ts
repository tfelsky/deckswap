...
const STATIC_ROUTES: Array<{
  ...
  { path: '/podmatch', changeFrequency: 'weekly', priority: 0.8 },
  { path: '/podmatch/users', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/podmatch/stores', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/for-stores', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/pricing', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/lgs-tv', changeFrequency: 'monthly', priority: 0.7 },
